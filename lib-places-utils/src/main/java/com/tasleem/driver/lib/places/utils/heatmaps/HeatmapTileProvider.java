...
package com.tasleem.driver.lib.places.utils.heatmaps;
...
import org.xms.g.maps.model.Tile;
import org.xms.g.maps.model.TileProvider;

import com.tasleem.driver.lib.places.utils.geometry.Bounds;
import com.tasleem.driver.lib.places.utils.geometry.Point;
import com.tasleem.driver.lib.places.utils.quadtree.PointQuadTree;
...
public class HeatmapTileProvider implements TileProvider {
    ...
    public Tile getTile(int x, int y, int zoom) {
        ...
        if (!tileBounds.intersects(paddedBounds)) {
            return TileProvider.getNO_TILE();
        }
