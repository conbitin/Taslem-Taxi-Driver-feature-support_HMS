...
import com.tasleem.driver.interfaces.CircularProgressViewListener;
...
public class CustomCircularProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        else canvas.drawArc(bounds, startAngle + indeterminateRotateOffset, indeterminateSweep, false, paint);
    }
